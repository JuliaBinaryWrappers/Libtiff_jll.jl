...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Libtiff_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("89763e89-9b03-5906-acba-b20f662cd828"))
...
if best_platform === nothing
    @debug("Unable to load Libtiff; unsupported platform $(triplet(platform_key_abi()))")
else
